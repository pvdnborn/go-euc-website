...
---
Citrix remoting protocol, HDX, includes support for the AV1 video codec since the 2311 release. AV1 is the successor of the H.265, which itself is the successor of the widely adopted H.264 codec. This research aims to compare the visual quality differences between the three codec using Citrix HDX protocol and how that could impact the user experience.
